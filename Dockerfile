...
RUN apt-get -y install php8.1-fpm php8.1-curl php8.1-xml php8.1-xml php8.1-bcmath php8.1-mbstring php8.1-redis php8.1-pgsql php8.1-gd php8.1-zip php8.1-mysql supervisor
